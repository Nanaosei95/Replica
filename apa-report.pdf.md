...
::: {.cell-output-display}
![](apa-report_files/figure-pdf/unnamed-chunk-5-1.pdf){fig-pos='H'}
:::
...
::: {.cell-output-display}
![](apa-report_files/figure-pdf/unnamed-chunk-5-2.pdf){fig-pos='H'}
:::
...
::: {.cell-output-display}
![](apa-report_files/figure-pdf/unnamed-chunk-5-3.pdf){fig-pos='H'}
:::
...
::: {.cell-output-display}
![](apa-report_files/figure-pdf/unnamed-chunk-5-4.pdf){fig-pos='H'}
:::
...
::: {.cell-output-display}
![](apa-report_files/figure-pdf/unnamed-chunk-5-5.pdf){fig-pos='H'}
:::
:::
...
::: {.cell}
::: {.cell-output-display}
![Price Index vs. Median Hour Gap](apa-report_files/figure-pdf/fig-hour-gap-1.pdf){#fig-hour-gap}
:::
:::
...
\toprule
& Full sample & After July 1, 2019 \\ \midrule %% TinyTableHeader
...
3. Configuring GitHub Repository: I pushed the updated folder to GitHub. In my GitHub repository, I went to Settings \> Pages, selected the main branch and the /docs folder as the source, and saved it.
Live Website Published: GitHub then generated a public URL (e.g., https://nanaosei95.github.io/Replica/), which I shared with others. 
...
1. Fork the repository: I first navigated to the public repository at https://github.com/hubchev/make_a_pull_request and forked it to my personal GitHub account.
