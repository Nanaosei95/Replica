...
function F = calc_bnprices_merger43(p,param,startval)
...
R4 = @(p1,p2,p5) fminunc(@(p43) -pi4(p1,p2,p43(1),p43(2),p5),[startval(3),startval(4)],fminopt); % Best response function
R5 = @(p1,p2,p3,p4) fminunc(@(p5) -pi5(p1,p2,p3,p4,p5),startval(5),fminopt); % Best response function

% Solver finds prices that make F=0
R4out = R4(p(1),p(2),p(5));
