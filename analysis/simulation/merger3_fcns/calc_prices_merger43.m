...
function [estpstar_merger43,pi,share,quant,cs,ps] = calc_prices_merger43(param,estpstar_start)
...
pi4 = @(p1,p2,p3,p4,p5) (p4-c)*s4(p1,p2,p3,p4,p5) + (p3-c)*s3(p1,p2,p3,p4,p5);
...
R4 = @(p1,p2) fminunc(@(p43) (-pi4(p1,p2,p43(1),p43(2),R5(p1,p2,p43(1),p43(2)))),[estpstar_start(3),estpstar_start(4)],fminopt);

%R3 = @(p1,p2) fminunc(@(p3) (-pi3(p1,p2,p3,R4(p1,p2,p3),R5(p1,p2,p3,R4(p1,p2,p3)))),estpstar_start(3),fminopt);

R2 = @(p1) fminunc(@(p2) (-pi2fcn43(pi2,p1,p2,R4,R5)),estpstar_start(2),fminopt);

estpstar_merger43(1) = fminunc(@(p1) (-pi1fcn43(pi1,p1,R2,R4,R5)),estpstar_start(1),fminopt);   

% Now solve for remaining equilibrium prices
estpstar_merger43(2) = R2(estpstar_merger43(1));

R4out = R4(estpstar_merger43(1),estpstar_merger43(2));
estpstar_merger43(3) = R4out(1);
estpstar_merger43(4) = R4out(2);

estpstar_merger43(5) = R5(estpstar_merger43(1),estpstar_merger43(2),estpstar_merger43(3),estpstar_merger43(4));


pstar = estpstar_merger43;
