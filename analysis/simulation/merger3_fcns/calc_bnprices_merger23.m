...
function F = calc_bnprices_merger23(p,param,startval)


fminopt=optimset('Display','off','UseParallel',false,'TolFun',1e-20,'TolX',1e-20,'MaxFunEvals',100000);
%fminsearchopt=optimset('Display','off','TolFun',1e-20,'MaxFunEvals',100000,'MaxIter',100000);
...
R3 = @(p1,p4,p5) fminunc(@(p32) -pi3(p1,p32(1),p32(2),p4,p5),[startval(2),startval(3)],fminopt); % Best response function
