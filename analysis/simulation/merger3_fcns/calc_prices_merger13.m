...
function [estpstar_merger13,pi,share,quant,cs,ps] = calc_prices_merger13(param,estpstar_start)
...
% Post merger
%pi1 = @(p1,p2,p3,p4,p5) (p3-c)*s3(p1,p2,p3,p4,p5);
pi2 = @(p1,p2,p3,p4,p5) (p2-c)*s2(p1,p2,p3,p4,p5);
pi3 = @(p1,p2,p3,p4,p5) (p3-c)*s3(p1,p2,p3,p4,p5) + (p1-c)*s1(p1,p2,p3,p4,p5);
...
R3 = @(p2) fminunc(@(p13) (-pi3fcn13(pi3,p13(1),p2,p13(2),R4,R5)),[estpstar_start(1),estpstar_start(3)],fminopt);

estpstar_merger13(2) = fminsearch(@(p2) (-pi2fcn13(pi2,p2,R3,R4,R5)),estpstar_start(2),fminsearch2);   

% Now solve for remaining equilibrium prices
R3out = R3(estpstar_merger13(2));
estpstar_merger13(1) = R3out(1);
estpstar_merger13(3) = R3out(2);

estpstar_merger13(4) = R4(estpstar_merger13(1),estpstar_merger13(2),estpstar_merger13(3));
estpstar_merger13(5) = R5(estpstar_merger13(1),estpstar_merger13(2),estpstar_merger13(3),estpstar_merger13(4));


pstar = estpstar_merger13;
