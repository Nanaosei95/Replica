...
function F = bnfcn_numerical_sub(p,param,startval)


fminopt=optimset('Display','off','UseParallel',false,'TolFun',1e-18,'TolX',1e-18,'MaxFunEvals',100000);
...
R3 = @(p1,p2,p4,p5) fminunc(@(p3) -pi3(p1,p2,p3,p4,p5),startval(3),fminopt); % Best response function
